...
class m0002_importData
{
    public function up()
    {
        ...
        $db = Application::$app->db;
        $sql = "INSERT INTO ecom.categories (id,name,created_at,updated_at) VALUES
        ...
        $db = Application::$app->db;
        $sql = "INSERT INTO ecom.products (id,category_id,name,image_url,price,description,created_at,updated_at) VALUES
...
INSERT INTO ecom.products (id,category_id,name,image_url,price,description,created_at,updated_at) VALUES
