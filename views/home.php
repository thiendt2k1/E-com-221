    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2000">
                <img src="/images/slider/inception_movie_poster_banner.jpg" class="d-block w-100" alt="..." width="1100px" height="440px" overflow= "hidden">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="/images/slider/The Avengers-Banner.jpg" class="d-block w-100" alt="..." width="1100px" height="440px" overflow= "hidden">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="/images/slider/The-Finest-Hours-Banner.jpg" class="d-block w-100" alt="..." width="1100px" height="440px" overflow= "hidden">
            </div>
        </div>
